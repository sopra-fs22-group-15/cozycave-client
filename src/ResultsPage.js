import { Modal, Button, Form, Row, Col, Figure, Container, Badge } from 'react-bootstrap'
            ...
            <Container fluid style={{ paddingLeft: 40, paddingRight: 0, paddingTop: 60 }}>
                {listings.map((listing) => (
                    <div className='d-inline-block border border-dark rounded' style={{ marginRight: 20, marginBottom: 3, width: "45%" }} onClick={() => openAdOverview(listing.uuid)}>
                        <Row>
                            <Col md={6}>
                                {displayPictures(listing.pictures)}
                            </Col>
                            <Col md={6}>
                                <Row className='g-2'>
                                    <Col md={5}>
                                ...
                                <Row className='g-2'>
                                    <h5>{listing.address.street} {listing.address.house_number}, {listing.address.zip_code} {listing.address.city}</h5>
                                </Row>
                                <Row className='g-2'>
                                    <div>
